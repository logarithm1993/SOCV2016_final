...
// things you can try:
// memory and deletion ^.<
// the data structure of cube and TCube and Frame
// order when generalize
// cone in need optimization
// if (_pdrActCount too much) recycleSolver();

// if you can understand these, I kneel down...
// Ask SillyDuck for above information....
...
class PDRMgr {
  ...
  private:
    ...
    V3Ntk*                    _ntk;
    vector< vector<Cube*>* >*  F;         // be care of the type of this data member
